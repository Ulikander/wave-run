...
namespace WASD.Runtime.Managers
{
    public class TaskManager : MonoBehaviour
    {
        public class TaskState
        {
            ...
            public TaskState(TaskManager manager, IEnumerator c)
            {
                _TaskManager = manager;
                coroutine = c;
            }
            ...
            {
                running = true;
                _TaskManager.StartCoroutine(CallWrapper());
            }
        ...
        public TaskState CreateTask(IEnumerator coroutine)
        {
            ...
            if (singleton == null)
            {
                ...
                GameObject go = Instantiate(new GameObject("TaskManager"));
                singleton = go.AddComponent<TaskManager>();
            }
            */
            return new TaskState(manager: this, c: coroutine);
        }
    }
}
